...
local my_language = {
    ...
    payday_message = "Maaş Günü! Maaşın: %s",
    payday_unemployed = "Maaşın olmadığı için maaş alamadın.",
    payday_missed = "Maaş Günü Geçti! ( Hapistesin )",
    ...
    warrant_ordered = "%s ordered a search warrant for %s. Sebep: %s",
    ...
    wanted_expired = "%s polis tarafından aranmıyor.",
    wanted_revoked = "%s polis tarafından aranmıyor.\nArama Emrini Geri Çeken: %s",
    ...
    keys_other_allowed = "Ortak mülke izin verildi:",
    keys_allow_ownership = "(Sahipliğe izin vermek için F2 ' ye basın')",
    keys_disallow_ownership = "(Press Reload with keys or press F2 to disallow ownership)",
    keys_owned_by = "Bu Kapının Sahibi:",
    ...
    door_cannot_afford = "Kapıyı almak için yeteri kadar paran bulunmamakta!",
    door_hobo_unable = "You can not buy a door if you are a hobo!",
    vehicle_cannot_afford = "You can not afford this vehicle!",
    door_bought = "Kapıyı %s%s karşılığında satın aldın.",
    ...
    remove_owner = "Sahip Sil",
    coown_x = "Co-own %s",
    allow_ownership = "Sahipliğe İzin Ver",
    disallow_ownership = "Sahiplikten Kaldır",
    edit_door_group = "Kapı Grubunu Düzenle",
    door_groups = "Kapı Grupları",
    door_group_doesnt_exist = "Kapı grubu mevcut değil!",
    door_group_set = "Kapı grubu başarıyla düzenlendi.",
    ...
    cannot_pocket_x = "Bunu cebine alamazsın!",
    object_too_heavy = "This object is too heavy.",
    pocket_full = "Pocket full!",
    pocket_no_items = "Cebinde hiç bir şey yok!",
    drop_item = "Drop item",
    ...
    -- Talking
    hear_noone = "Kimse seni duymuyor!",
    hear_everyone = "Herkes seni duyuyor!",
    hear_certain_persons = "Sizi duyabilen oyuncular",
    ...
    you_bought_x = "%s isimli öğeyi %s%d satın aldın.", -- backwards compatibility
    you_bought = "%s isimli öğeyi %s satın aldın.",
    ...
    cannot_drop_weapon = "Bu silahı yere bırakamazsın!",
    ...
    i_want_to_demote_you = "I want to demote you. Sebep: %s",
    tried_to_avoid_demotion = "You tried to escape demotion. You failed and have been demoted.", -- naughty boy!
    lockdown_started = "Başkan OHAL ilan etti, lütfen evlerinize geri dönünüz!",
    lockdown_ended = "OHAL Başkan tarafından sonlandırıldı",
